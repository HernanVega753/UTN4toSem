...
def mostrar_pantalla_inicio(screen):
    ...
    # reproducir audio
    pygame.mixer.load(IMPERIAL_MARCH_PATH)
    pygame.mixer.play()
...
def main():
    ...
    fondo = pygame.transform.scale(fondo0, (SCREEN_WIDTH, SCREEN_HEIGHT))
    ...
    solido_laser = pygame.mixer.Sound(f'{ASSETS_PATH}/sounds/explosion.op3')
    ...
    for laser in personaje.lasers:
        ...
        if puntos >= 250:
            if fondo_actual == fondo
                ...
                screen.fill(0,0,0)
                texto_game_over = font.render('GAME OVER', (255, 0, 0))
